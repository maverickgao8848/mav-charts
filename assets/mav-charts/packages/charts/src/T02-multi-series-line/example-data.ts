import type { MultiSeriesLineDatum } from "./schema";

export const multiSeriesLineExample = [
  { label: "Q1", value: 28, comparison: 24 },
  { label: "Q2", value: 34, comparison: 31 },
  { label: "Q3", value: 42, comparison: 36 },
  { label: "Q4", value: 57, comparison: 45, detail: "Latest reporting period" },
] as const satisfies readonly MultiSeriesLineDatum[];

export const multiSeriesLineEdgeCases = {
  empty: [] as readonly MultiSeriesLineDatum[],
...
} as const satisfies Record<string, readonly MultiSeriesLineDatum[]>;
